    ...
    <main>
      ...
      <section className="w-f p-4">
        ...
        <div className="my-4 flex items-center justify-between w-full max-w-md mx-auto">
          ...
          <div className="flex flex-col items-center text-gray-500 rounded-full bg-gray-300 p-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <div className="flex flex-col items-center rounded-full bg-gray-300 p-1 text-gray-500">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
