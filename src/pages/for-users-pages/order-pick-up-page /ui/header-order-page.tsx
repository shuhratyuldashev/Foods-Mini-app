...
const HeaderOrderPage = () => {
  return (
    <header className="p-4 flex gap-2 items-center bg-black">
      <Link to="/cart">
      ...
      <div className="p-2 rounded-full bg-white w-full">
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col text-sm">
            <h2 className="font-semibold">Cristopert Dastin</h2>
            <p className="text-gray-400">ID 213752</p>
          </div>
          <div className="ml-auto flex gap-2">
            <button className="bg-primary rounded-full text-white p-2 as">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
