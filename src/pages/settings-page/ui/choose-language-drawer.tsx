      ...
      <DrawerContent>
        <div className="p-4 flex flex-col gap-2">
          ...
          {languages_list.map((l) => (
            <div onClick={() => setCurrentLanguage(l.title)} className={`flex items-center gap-2 w-full p-2 border-1 ${currentLanguage === l.title && "border-primary border-2"} rounded-md`}>
              <div className="rounded-full py-1 px-2 bg-gray-200">
                {l.icon}
              </div>
