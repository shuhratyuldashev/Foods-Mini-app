      ...
      <form className="mt-5">
        <InputOTP className="w-full" maxLength={4}>
          <InputOTPGroup className="w-full">
            <InputOTPSlot index={0} className="w-1/4 aspect-square min-h-[75px]"/>
            <InputOTPSlot index={1} className="w-1/4 aspect-square min-h-[75px]"/>
            <InputOTPSlot index={2} className="w-1/4 aspect-square min-h-[75px]"/>
            <InputOTPSlot index={3} className="w-1/4 aspect-square min-h-[75px]"/>
          </InputOTPGroup>
        </InputOTP>

        <p className="font-medium text-center text-gray-400 text-sm mt-10">Didn’t receive code? <span className="text-primary font-semibold">Resend</span></p>
