...
import { payment_deliver_constants, payment_details_constants } from "./constants/payment-fulll-details-list";
        ...
        <section className="flex flex-col mt-4">
           ...
           <div className="flex flex-col">
             ...
             {payment_details_constants.map((d) => (
                <div key={d.id} className="w-full mt-2 flex justify-between items-center">
                    <p>{d.title}</p>
           ...
           <button className="p-4 w-full text-center bg-primary text-white font-semibold rounded-full mt-16">Chackout Now</button>
        </section>
    </main>
  )
}
